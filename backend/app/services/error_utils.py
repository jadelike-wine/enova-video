...
ERROR_CODES = {
    ...
    # ---- 更新 / 回滚错误码（稳定，供脚本与 API 定位）----
    "UPDATE_CHECK_FAILED": "UPDATE_CHECK_FAILED",
    "UPDATE_PRECHECK_FAILED": "UPDATE_PRECHECK_FAILED",
    "UPDATE_BACKUP_FAILED": "UPDATE_BACKUP_FAILED",
    "UPDATE_PULL_FAILED": "UPDATE_PULL_FAILED",
    "UPDATE_IMAGE_VERIFY_FAILED": "UPDATE_IMAGE_VERIFY_FAILED",
