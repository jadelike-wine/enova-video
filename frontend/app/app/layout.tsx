      ...
      <div className="flex h-screen overflow-hidden">
        ...
        <aside className="w-72 flex-shrink-0 glass-sidebar rounded-r-3xl flex flex-col m-2 mr-0">
          <Link href="/" className="p-6 border-b border-white/10 block">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-white/50 mt-0.5">多模态 Web 客户端</p>
              </div>
            </div>
          </Link>
          ...
          <div className="p-5 border-t border-white/10">
            <p className="text-xs text-white/40 text-center flex items-center justify-center gap-1.5 flex-wrap">
              <a
                href="https://github.com/jiyiren/agnes-ai-creator"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 text-white/50 hover:text-cyan-300 transition-colors"
              >
                <svg
