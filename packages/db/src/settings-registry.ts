...
export const SETTINGS: SettingDef[] = [
  ...
  // ---- 注册设置 ----
  {
    key: 'auth.openRegistration',
    valueType: 'boolean',
    group: 'auth',
    label: '开放注册',
    description: '允许新用户注册。关闭后禁止新用户注册。',
    envKey: 'OPEN_REGISTRATION',
    envDefault: 'true',
  },
  {
    ...
    group: 'auth',
    label: '邮箱验证',
    description: '新用户注册时需要验证邮箱。开启后注册流程发送验证邮件，完成验证后才能使用账号。',
    envKey: 'EMAIL_VERIFICATION',
    envDefault: 'false',
  },
  {
    key: 'auth.emailDomainWhitelist',
    valueType: 'string',
    group: 'auth',
    label: '邮箱域名白名单',
    description: 'JSON 数组，仅允许指定域名的邮箱注册。支持 @example.com 和 *.edu.cn 格式。留空则不限制。',
    envKey: 'EMAIL_DOMAIN_WHITELIST',
    envDefault: '[]',
  },
  {
    key: 'auth.nonWhitelistDomainLimit',
    valueType: 'boolean',
    group: 'auth',
    label: '非白名单域名限量注册',
    description: '开启后，如果邮箱白名单非空，非白名单域名允许注册但每个主域名最多注册一个账户。关闭后非白名单域名直接拒绝注册。白名单为空时此开关无效。',
    envKey: 'NON_WHITELIST_DOMAIN_LIMIT',
    envDefault: 'false',
  },
  {
    key: 'auth.enablePromoCode',
    valueType: 'boolean',
    group: 'auth',
    label: '优惠码',
    description: '允许用户注册时使用优惠码。开启后注册页面显示优惠码输入。',
    envKey: 'ENABLE_PROMO_CODE',
    envDefault: 'false',
  },
  {
    key: 'auth.requireInvitationCode',
    valueType: 'boolean',
    group: 'auth',
    label: '邀请码注册',
    description: '开启后用户注册必须填写有效邀请码。',
    envKey: 'REQUIRE_INVITATION_CODE',
    envDefault: 'false',
  },
  {
    key: 'auth.enablePasswordReset',
    valueType: 'boolean',
    group: 'auth',
    label: '忘记密码',
    description: '允许用户通过邮箱重置密码。开启后显示忘记密码入口，关闭后禁止邮箱重置密码。',
    envKey: 'ENABLE_PASSWORD_RESET',
    envDefault: 'true',
  },
  // ---- 支付（成组原子更新）----
  {
  ...
  },
  {
    ...
    group: 'general',
    label: '协议文档',
    description: 'JSON 数组，每项含 slug、title、contentMd。路由标识 slug 可输入完整路径如 /legal/terms，后端自动提取最后一段。',
